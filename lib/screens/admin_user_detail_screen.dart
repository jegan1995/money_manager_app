...
class _AdminUserDetailScreenState
  ...
  List<_FeatureItem> get _featureList => [
    ...
    _FeatureItem('subscriptions','Subscriptions', Icons.subscriptions,  const Color(0xFF667eea),
        'Track recurring subscriptions'),
    _FeatureItem('bills',      'Bill Reminders', Icons.receipt,          const Color(0xFF1A237E),
        'Track bill due dates'),
    _FeatureItem('investments','Investments',    Icons.trending_up,      const Color(0xFF1B5E20),
        'Portfolio tracker'),
